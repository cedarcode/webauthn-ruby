  ...
  module AttestationStatement
    class FidoU2f < Base
      ...
      def find_metadata
        ...
        @fido_metadata_entry = fido_metadata_store.fetch_entry(attestation_certificate_key_id: key_id)
        @fido_metadata_statement = fido_metadata_store.fetch_statement(attestation_certificate_key_id: key_id)
      end
    end
  end
end
